...
<div style="background: #fde68a; padding: 1rem; color: #b45309; border-radius: 0.75rem;"><strong>⚠️ Warning:</strong> Nuxt 3 is still in beta and is not recommended for production use.</div>
...
<script setup>
import { CloudUploadIcon } from '@heroicons/vue/outline' // use '@heroicons/vue/solid' for the solid versions
</script>
```
...
<div style="background: #bfdbfe; padding: 1rem; color: #1d4ed8; border-radius: 0.75rem;">ℹ Note: If you want to re-create the pages functionality from the demo site, follow the next 2 steps.<br/> If you're ready get cracking on your own thing, just skip the next two steps and start building out your own collections in Directus.</div>
...
**Remove all the example content**
